    ...
    <div className='filters-container'>
        ...
        <div className='location-post-container'>
            <div className='location-post-left'>
                ...
                <Select options={optionsLocation}   className="react-select-container-mobile" classNamePrefix="react-select" placeholder="Location"/>
            </div>
            <button className='post-button'>Post ad</button>
        </div>
        <input className='searchbar' type='text' placeholder='Search for any textbook'></input>
        <div className='page-results'>Page 1 - 340 results</div>
        <div className='filter-by'>
            <div>Filter By</div>
            <IoFilter size={24} color='black'/>
        </div>
        <Select options={optionsLocation}   className="react-select-container location-container" classNamePrefix="react-select" placeholder="Location" />
